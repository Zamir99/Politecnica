...
@Component({
  selector: 'app-modalidad-presencial-cun',
  templateUrl: './modalidad-presencial-cun.component.html',
  styleUrls: ['./modalidad-presencial-cun.component.css']
})
export class ModalidadPresencialCunComponent implements OnInit {
